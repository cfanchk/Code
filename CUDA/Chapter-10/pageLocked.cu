...
int main()
{
	...
	printf("Time using cudaMalloc: %3.3f ms, ", elapsedTime);
	printf("MB/s during copy up: %3.3f.\n", MB/(elapsedTime/1000));

	elapsedTime = cuda_malloc_test(SIZE, false);
	printf("Time using cudaMalloc: %3.3f ms, ", elapsedTime);
	printf("MB/s during copy down: %3.3f.\n", MB/(elapsedTime/1000));

	elapsedTime = cuda_host_alloc_test(SIZE, true);
	printf("Time using cuda_host_alloc: %3.3f ms, ", elapsedTime);
	printf("MB/s during copy up: %3.3f.\n", MB/(elapsedTime/1000));
