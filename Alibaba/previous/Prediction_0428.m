% 在0426基础上修改，51行起，直接利用201512月起的数据进行预测，而非2014年相应的数据，且将t改为0.3
...
ind = data(:,1)>=20141010 & data(:,1)<20150501 ...
...
if(n_train<40)
    ...
    trainX = [data(ind,7:10),data(ind,21:22),data(ind,25:26)];
